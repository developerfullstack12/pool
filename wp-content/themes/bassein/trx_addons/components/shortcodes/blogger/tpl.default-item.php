		...
		if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) {
			?><div class="sc_blogger_item_excerpt">
				<div class="sc_blogger_item_excerpt_text">
					...
					if (has_excerpt()) {
						bassein_the_excerpt_max_charlength(180);;
				...
				// More button
				if ( $show_more ) {
					?><div class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($post_link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button color_style_link3 sc_button_default sc_button_size_small', 'sc_blogger', $args)); ?>"><?php esc_html_e('more info', 'bassein'); ?></a></div><?php
				}
