...
if ( !function_exists( 'bassein_vc_get_css' ) ) {
	add_filter( 'bassein_filter_get_css', 'bassein_vc_get_css', 10, 4 );
	function bassein_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.wpb-js-composer .vc_tta.vc_general .vc_tta-icon, .wpb-js-composer .vc_tta-color-white.vc_tta-style-classic .vc_tta-tab>a{
	color: {$colors['text_light']};
}
.wpb-js-composer .vc_tta-color-white.vc_tta-style-classic .vc_tta-tab.vc_active>a, .wpb-js-composer .vc_tta-color-white.vc_tta-style-classic .vc_tta-tab.vc_active>a .vc_tta-icon{
	color: {$colors['text_dark']};
}
...
.wpb-js-composer .vc_tta-color-white.vc_tta-style-classic .vc_tta-tab>a:hover .vc_tta-icon{
	color: {$colors['text_dark']};
