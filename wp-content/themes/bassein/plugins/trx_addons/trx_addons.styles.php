...
if (!function_exists('bassein_trx_addons_get_css')) {
	add_filter('bassein_filter_get_css', 'bassein_trx_addons_get_css', 10, 4);
	function bassein_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_slider_controls.sc_align_left .slider_prev:hover, .sc_slider_controls.sc_align_left .slider_next:hover{
	color: {$colors['text_link']};
}
...
.slider_outer.slider_style_default.slider_outer_pagination_pos_left_outside .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active{
	background-color: {$colors['text_link']};
}
...
.page_content_wrap .content_wrap .widget_contacts .contacts_info span:before{
	color: {$colors['text_link']};
}
...
.widget_recent_posts .post_item .post_content .post_info .post_info_date:hover{
	color: {$colors['text_link']};
}
...
.sc_action_item.sc_action_item_simple .sc_action_item_subtitle {color:{$colors['text_dark']}; }
...
.sc_action_item_default .sc_action_item_subtitle:before{
	background-color:{$colors['text_link']};
}
...
.sc_price_item_subtitle, .sc_price_item_price, .sc_price_item .sc_price_item_title{
	background-color: {$colors['text_link3']};
}
...
.sc_services_light .sc_services_item_featured_top.with_image .sc_services_item_description{
...
.sc_team.sc_team_default .sc_item_button .sc_team_button:hover{
	background-color: {$colors['text_hover2']};
}
...
.sc_contact_form7.sc_contact_form7_button .wpcf7-submit, .sc_contact_form7.sc_contact_form7_button_left input[type="submit"]{
	background-color: {$colors['text_link2']};
}
.sc_contact_form7.sc_contact_form7_button .wpcf7-submit:hover, .sc_contact_form7.sc_contact_form7_button_left input[type="submit"]:hover{
	background-color: {$colors['text_hover2']};
}
...
.light-text input::-webkit-input-placeholder{ color: {$colors['extra_light']}; opacity: 1;}
.light-text input::-moz-placeholder{ color: {$colors['extra_light']};opacity: 1; }
.light-text input:-ms-input-placeholder{ color: {$colors['extra_light']};opacity: 1; }

.light-text textarea::-webkit-input-placeholder{ color: {$colors['extra_light']}; opacity: 1;}
.light-text textarea::-moz-placeholder{ color: {$colors['extra_light']};opacity: 1; }
.light-text textarea:-ms-input-placeholder{ color: {$colors['extra_light']};opacity: 1; }
.light-text .select_container select{ color: {$colors['extra_light']};opacity: 1; background-color: {$colors['inverse_link']}!important; }

.light-text input, .light-text textarea{
	background-color: {$colors['inverse_link']};
	border-color: {$colors['inverse_link']};
}
.light-text .select_container:before{background-color: {$colors['inverse_link']};}


/**/
.tp-bullet{
	background-color: {$colors['extra_text']}!important;
}
.tp-bullet.selected{
	background-color: {$colors['text_link2']}!important;
}
