...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Bassein'.
Please install and activate it before starting to use the theme Bassein.
...
Theme documentation is available on http://bassein.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Bassein is Fontello.
