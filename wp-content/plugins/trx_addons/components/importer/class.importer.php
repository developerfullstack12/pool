			...
			?><div class="trx_importer_section">
				...
				<form id="trx_importer_form">
					...
					<div class="trx_importer_demo_set">
                        ...
                        <label><input type="radio"<?php if ($this->options['demo_set']=='full') echo ' checked="checked"'; ?> value="full" name="demo_set" /><?php esc_html_e('Whole demo-site content: all existing contents', 'trx_addons'); ?><span> of your website will be deleted and replaced with the new data!</span></label>
